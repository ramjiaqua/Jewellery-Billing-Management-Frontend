...
export default function ViewChitSchemeTable() {
    const [salesBills, setSalesBills] = useState<any[]>([]);
    const [chitScheme, setChitScheme] = useState<any[]>([]);
    ...
    useEffect(() => {
        void fetchViewScheme();
    }, []);

    const fetchViewScheme = async () => {
        try {
            const response = await api.get("/api/chitscheme");
            console.log("Customers API:", response.data);
            console.log(response);
            setChitScheme(response.data);
